...
import logo_black from 'assets/images/flexword_Logo_3_black.jpg';
import logo_white from 'assets/images/flexword_Logo_3_white.jpg';
...
const LogoMain = ({ reverse }) => {
  ...
  return (
     ...
     *
     */
    <img src={theme.palette.mode === 'dark' ? logo_black : logo_white} width={reverse ? '100' : '120'} alt="flexword" />
    // <>
